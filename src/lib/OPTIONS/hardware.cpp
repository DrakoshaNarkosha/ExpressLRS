...
static const struct {
    ...
    {HARDWARE_frequency_custom, "frequency_custom", BOOL},
    {HARDWARE_frequency_minimum, "frequency_minimum", INT},
    {HARDWARE_frequency_maximum, "frequency_maximum", INT},
    {HARDWARE_frequency_count, "frequency_count", INT},
    {HARDWARE_frequency_center, "frequency_center", INT},
    ...
    {HARDWARE_power_enable_pa_boost, "power_enable_pa_boost", ARRAY},
